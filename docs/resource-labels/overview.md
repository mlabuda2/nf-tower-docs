...
Note that the cloud provider credentials used by Tower must have the appropriate roles to tag resources in your environment. 
...
The credentials used by Tower must have the appropriate roles to tag resources in your environment. 
