...
16. To use **EFS**, you can either select **Use existing EFS file system** and specify an existing EFS instance, or select **Create new EFS file system** to create one. For new and existing EFS file systems, you will need to specify `<your_EFS_mount_path>/work` as your **Pipeline work directory** (step 8 of this guide).
